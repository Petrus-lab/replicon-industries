...
function testFirebaseLive() {
    // Minimal real check: can we use firebase-admin and read a property?
    try {
...
async function testVercelLive() {
    try {
        ...
        // We check the projects endpoint, which requires valid token
        const url = 'https://api.vercel.com/v2/projects?limit=1';
        ...
        return '❌ Vercel error: ' + (e.response?.data?.error?.message || e.message);
    }
}
...
app.post('/run', async (req, res) => {
    ...
    try {
        // Existing handlers for shell/python/read/write/json...
        ...
        // ...rest of your /run logic unchanged...
